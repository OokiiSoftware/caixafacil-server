...
class NfeLocalEntrega extends Model<InferAttributes<NfeLocalEntrega>, InferCreationAttributes<NfeLocalEntrega>> {
 declare id: number;
 declare id_nfe_cabecalho: number;
 declare cnpj: string;
 declare cpf: string;
 declare nome_recebedor: string;
...
NfeLocalEntrega.init({
 ...
 inscricao_estadual: {
  ...
  {
    sequelize,
    modelName: "nfe_local_entrega",
  },
);

export default NfeLocalEntrega;